...
const Nav=(props)=>{
  return (
    <nav className='navbar navbar-light sticky-top py-0' id='navbar'>
      ...
      <button className='navbar-toggler mr-5' type='button' 
        data-bs-toggle='offcanvas' data-bs-target='#nav_contents'>
        <span className='navbar-toggler-icon'></span>
      </button>
      
      <div className='offcanvas offcanvas-end bg-dark' tabIndex='-1' id='nav_contents' aria-labelledby='navbarOffcanvas'>
        <div className='offcanvas-header bg-secondary'>
          <div className='offcanvas-title text-dark'><h2 className=''>Menu</h2></div>
